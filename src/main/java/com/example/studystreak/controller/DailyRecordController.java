...
public class DailyRecordController {
    ...
    public ResponseEntity<DailyRecordResponseDTO> createDailyRecord(
        ...
        DailyRecordResponseDTO savedRecord =
                dailyRecordService.createDailyRecord(goalId, dailyRecordRequest);
    ...
    @GetMapping
    public ResponseEntity<Page<DailyRecordResponseDTO>> getGoalDailyRecords(
            @PathVariable Long goalId,
            Pageable pageable
    ) {
    ...
    public ResponseEntity<DailyRecordResponseDTO> getDailyRecords(
            @PathVariable Long goalId,
            @PathVariable Long dailyRecordId
    ) {
        return ResponseEntity.ok(
                dailyRecordService.getDailyRecordById(goalId, dailyRecordId)
        );
    }
    ...
    public ResponseEntity<DailyRecordResponseDTO> updateDailyRecord(
        ...
        return ResponseEntity.ok(
                dailyRecordService.updateDailyRecord(
                        goalId,
                        dailyRecordId,
                        dailyRecordRequest
                )
